...
%function cktnetlistout = add_element(cktnetlist, MODorCKT, elname, nodes,...
%                                                             parms, uinfo)
...
%
% - MODorCKT: ModSpec model object (structure) for the device to be added
%             or subcktnetlist for the subcircuit to be added
%             Note that a subcktnetlist has the same structure as a normal
%                 cktnetlist, except that subcktnetlist has one extra field:
%                 'terminalnames' (a cellarray of strings), containing
%                 names of its terminals, which are subset of its non-ground
%                 nodes.
%
...
%             ModSpec device MOD (or terminals in subcktnetlist), and be in the
%             same order as in the ModSpec's definition (or
%             subcktnetlist.terminalnames).
%
...
%--------
%
% MAPPcktnetlists, MAPPanalyses, MNA_EqnEngine[TODO], DAE_concepts, DAEAPI
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
